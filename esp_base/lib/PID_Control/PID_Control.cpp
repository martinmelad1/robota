...
static WheelGains velGains[4] = {
    {2.5f, 2.0f, 0.0f}, {2.5f, 2.0f, 0.0f}, {2.5f, 2.0f, 0.0f}, {2.5f, 2.0f, 0.0f}};

static PID pidVel[4] = {
    PID(&velAct[0], &velOut[0], &velSet[0], velGains[0].Kp, velGains[0].Ki, velGains[0].Kd, DIRECT),
    PID(&velAct[1], &velOut[1], &velSet[1], velGains[1].Kp, velGains[1].Ki, velGains[1].Kd, DIRECT),
    PID(&velAct[2], &velOut[2], &velSet[2], velGains[2].Kp, velGains[2].Ki, velGains[2].Kd, DIRECT),
    PID(&velAct[3], &velOut[3], &velSet[3], velGains[3].Kp, velGains[3].Ki, velGains[3].Kd, DIRECT)};

static const float FF_GAIN = 3.8f;
